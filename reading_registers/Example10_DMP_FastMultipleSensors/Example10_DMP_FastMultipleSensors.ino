...
#define AD0_VAL 0      // The value of the last bit of the I2C address.                \1101000
                       // On the SparkFun 9DoF IMU breakout the default is 1, and when \
                       // the ADR jumper is closed the value becomes 0
                       // inverted from actual value
...
ICM_20948_Status_e ICM_20948::initializeDMP(void)
{
  ...
  // Disable the FIFO
  result = enableFIFO(true); if (result > worstResult) worstResult = result;

  // Disable the DMP
  result = enableDMP(true); if (result > worstResult) worstResult = result;
